...
public class Grid extends JComponent implements KeyListener, MouseListener
{
  ...
  {
	//String image = "Background.gif"; //Change background to an image
  ...
  private void init(int numRows, int numCols)
  {
    ...
    frame.pack();
    frame.setVisible(true); //This maximizes the program window.
  }
  ...
  public void paintComponent(Graphics g)
  {
    for (int row = 0; row < getNumRows(); row++)
    {
      for (int col = 0; col < getNumCols(); col++)
      {
        ...
        //cell.setImageFileName("Background.gif");
      
        String imageFileName = cell.getImageFileName();
        //String imageFileName = "Background.gif"; //Change background to an image
